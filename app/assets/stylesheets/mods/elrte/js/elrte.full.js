...
//DIVEBOARD			d.append([this.rte.i18n('Margins'), this.src.margin], null, true);
...
elRTE.prototype.ui.prototype.buttons.image = function(rte, name) {
	...
	this.command = function() {
		...
		dialog.tab('main', this.rte.i18n('Properies'))
			...
			.append([this.rte.i18n('or Image UPLOAD'), $('<span />').append('<button>upload</button>')],                 'main', true)
...
elRTE.prototype.ui.prototype.buttons.link = function(rte, name) {
	...
	this.command = function() {
		...
		if (this.rte.options.fmAllow && this.rte.options.fmOpen) {
			...
			d.append([this.rte.i18n('Location name'), s], 'main', true);
		} else {

			d.append([this.rte.i18n('Location name'), this.src.main.href], 'main', true);
		}
		this.src.main.href.change();
		
		d.append([this.rte.i18n('Location name'), this.src.main.title.val(this.rte.dom.attr(link, 'location'))], 'main', true);
