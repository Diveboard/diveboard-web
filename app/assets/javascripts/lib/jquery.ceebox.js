...
function addGallery(g,family,opts){ // adds gallery next/prev functionality
	...
	function navLink(btn,id) {
		...
		var style = function(y) {return $.extend({zIndex:10005,width:nav[opts.type].w + px, height:nav[opts.type].h + px,position:"absolute",top:nav[opts.type].top,backgroundPosition:s[1] + " " + y + px},s[0]);};
