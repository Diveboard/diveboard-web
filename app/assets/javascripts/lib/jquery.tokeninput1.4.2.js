...
$.TokenList = function (input, url_or_data, settings) {
    ...
    function resize_input() {
		...
		//console.log(input_resizer.width());
    }
	...
	//TODO add qtips to all elements and launch qtip
        dropdown
            .css({
                position: "absolute",
    ...
    function populate_dropdown (query, results) {
        if(results && results.length) {
            ...
            $.each(results, function(index, value) {
                ...
                this_li.addClass("qtip-fishlist");
				if (value.picture != "")
 					this_li.attr("title", '<img src=\"'+ value.picture +'\"/> '+"<b>"+value.sname+"</b>");
				else
					this_li.attr("title", "<b>"+value.sname+"</b>");
