DiveBoard::Application.routes.draw do
  ...
  constraints :domain => /^(?!scu\.bz)(\w+)/ do
...
##    match '/api/search_any' => 'search#search_any'
  ...
  constraints :domain => "scuba.actvt.com" do
    scope module: 'v2' do
      ...
      ##resources :shop_pages
      match '/pro/:vanity_url' => 'shop_pages#index', :vanity_url => /[A-Za-z\.0-9\-\_]*/
      match '/pro/area/:vanity_url' => 'area_pages#index_with_id', :vanity_url => /[0-9\-\_]*/
      match '/pro/area/:vanity_url' => 'area_pages#index', :vanity_url => /[A-Za-z\.0-9\-\_\%\+]*/
      match '/checkout' => 'checkout#index'
      match '/payment_success' => 'checkout#success'

      match '/explore/gallery' => 'explore#gallery'
      match '/api/search' => 'api#search_area'
      match '/api/lightframe_data' => 'api#lightframe_data'
      match 'v2/logout' => '::login#deleteV2'
    end
  end
