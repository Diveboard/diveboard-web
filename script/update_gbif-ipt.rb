...
records.each do |record|
  ...
  begin
    ...
    when 1
      ...
      #Name of the Diver| eventDate|through: references =>  dimibrosens|2013-07-05|through: https://www.diveboard.com/dimibrosens/D1PROVr 
